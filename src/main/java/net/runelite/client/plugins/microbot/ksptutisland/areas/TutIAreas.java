package net.runelite.client.plugins.microbot.ksptutisland.areas;

import net.runelite.api.coords.WorldArea;

public class TutIAreas
{
    public static final WorldArea START_AREA = new WorldArea(3092, 3100, 4, 13, 0);
    public static final WorldArea SURVIVAL_AREA = new WorldArea(3098, 3089, 8, 11, 0);
    public static final WorldArea COOKING_AREA = new WorldArea(3073, 3083, 6, 4, 0);
    ...
    public static final WorldArea TUT_ISLAND_BANK_AREA = new WorldArea(3118, 3119, 7, 7, 0);
    public static final WorldArea BOND_INFO_AREA = new WorldArea(3125, 3123, 5, 3, 0);
    public static final WorldArea CHURCH_AREA = new WorldArea(3120, 3103, 8, 8, 0);
    public static final WorldArea TUTORIAL_END_AREA = new WorldArea(3140, 3084, 4, 6, 0);
}
