...
Edit the plugin source directly. Follow project rules (AGENTS.md + `../Microbot/AGENTS.md`):
...
- `AGENTS.md` — project rules (plugin descriptor fields, version bumping, threading, event subscription).
